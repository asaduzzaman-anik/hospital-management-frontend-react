...
export function ProfileEditPage() {
  const { user, setUser, patientProfile, refreshProfiles, setPatientProfile } = useAuth()
  ...
  async function saveAccount(event) {
    ...
    try {
      const saved = await usersApi.update(user.id, account)
  ...
  return (
    <div>
      <PageHeader
        title="Edit profile"
        breadcrumb={[{ label: 'Profile', to: '/profile' }, { label: 'Edit' }]}
